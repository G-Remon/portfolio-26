...
export const ExperienceData = [
  {
    ...
    description:
      "I studied computer and systems engineering, which provided me with a solid foundation in programming, algorithms, data structures, and software engineering.",
    left: false,
  ...
  },
  {
    ...
    foundation: "Scale AI",
    description:
      "Worked on improving a language model for solving Codeforces problems.",
    left: true,
...
export const IconOptions = [
  { name: "GiGraduateCap", component: MdSchool, label: "Graduate Cap" },
  { name: "FaBriefcase", component: FaBriefcase, label: "Briefcase" },
  { name: "MdSchool", component: MdSchool, label: "School" },
  { name: "MdWork", component: MdWork, label: "Work" },
  { name: "MdCode", component: MdCode, label: "Code" },
  { name: "MdScience", component: MdScience, label: "Science" },
  { name: "MdVolunteerActivism", component: MdVolunteerActivism, label: "Volunteer" },
];
